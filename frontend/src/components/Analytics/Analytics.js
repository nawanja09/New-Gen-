...
function Analytics({ transactions }) {
    ...
    const categories = ['Repeiring the desktops and laptops', 'Selling computer parts', 'CCTV services', 'Other Income', 'Employee Salary', 'Equipment Purchase', 'Building Rent', 'Other Expense']
            ...
            <div className="row">
                <div className="col-md-4 mt-3">
                    <div className="transactions-count">
                        ...
                        <hr />
                        <h5 className='hi'>Income: {totalIncomeTransactions.length}</h5>
                        <h5 className='he'>Expense: {totalExpenseTransactions.length}</h5>
                ...
                <div className="col-md-4 mt-3">
                    <div className="transactions-count">
                        ...
                        <hr />
                        <h5 className='hi'>Income: {totalIncomeTurnover}</h5>
                        <h5 className='he'>Expense: {totalExpenseTurnover}</h5>
