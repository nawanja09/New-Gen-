...
router.post('/get-user-info-by-id', authMiddleware, async (req,res) => {
  ...
  try {
       // Extract user ID from the token decoded by the authentication middleware
...
router.post("/apply-employee",authMiddleware, async (req, res) => {
  try {
    ...
    unseenNotifications.push({
        ...
        message:`${newemployee.firstName} ${newemployee.lastName} has applied`,
        data:{
...
router.get("/get-all-approved-employees", authMiddleware, async (req, res) => {
  try {
...
router.post("/book-appointment", authMiddleware, async (req, res) => {
  try {
    ...
    //pushing notifications to the employee based on his userId
