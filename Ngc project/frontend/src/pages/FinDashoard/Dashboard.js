...
function Dashboard() {
    ...
    const getTransactions = async () => {
        try {
            ...
            setLoading(true)
            const response = await axios.post(`${BACKEND_URL}/api/transactions/get-all-transactions`, { userid: user._id, frequency, ...(frequency === 'custom' && { selectedRange }), type })
    ...
    const deleteTransaction = async (record) => {
        try {
            setLoading(true)
            await axios.post(`${BACKEND_URL}/api/transactions/delete-transaction`, { transactionId: record._id })
